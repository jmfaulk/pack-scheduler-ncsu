...
public class CourseTest {
	...
	public void testCourseStringStringStringIntStringStringIntInt() {
		...
		Course c = null;
		try {
			c = new Course(null, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, CLASS_SIZE, MEETING_DAYS, START_TIME, END_TIME);
			fail();
		...
		c = null;
		try {
			c = new Course("", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, CLASS_SIZE, MEETING_DAYS, START_TIME, END_TIME);
			fail();
		} catch (IllegalArgumentException e) {
			assertNull(c);
		}
		...
		c = null;
		try {
			c = new Course("E11", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, CLASS_SIZE, MEETING_DAYS, START_TIME, END_TIME);
			fail();
		} catch (IllegalArgumentException e) {
			assertNull(c);
		}
		...
		c = null;
		try {
			c = new Course("CSC2167", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, CLASS_SIZE, MEETING_DAYS, START_TIME, END_TIME);
			fail();
		} catch (IllegalArgumentException e) {
			assertNull(c);
		}
		...
		c = null;
		try {
			c = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, CLASS_SIZE, MEETING_DAYS, START_TIME, END_TIME);
	...
	public void testCourseStringStringStringIntStringString() {
		...
		Course c = null;
		try {
			c = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, CLASS_SIZE, "A");
			assertEquals(NAME, c.getName());
			assertEquals(TITLE, c.getTitle());
			assertEquals(SECTION, c.getSection());
			assertEquals(CREDITS, c.getCredits());
	...
	public void testSetTitle() {
		Course c = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, CLASS_SIZE, MEETING_DAYS, START_TIME, END_TIME);
		assertEquals(NAME, c.getName());
		assertEquals(TITLE, c.getTitle());
		assertEquals(SECTION, c.getSection());
		assertEquals(CREDITS, c.getCredits());
	...
	public void testGetMeetingString() {
		...
		Activity c1 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, CLASS_SIZE, MEETING_DAYS, START_TIME, END_TIME);
		assertEquals("MW 1:30PM-2:45PM", c1.getMeetingString());
		Activity c2 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, CLASS_SIZE, MEETING_DAYS, 900, 1035);
		assertEquals("MW 9:00AM-10:35AM", c2.getMeetingString());
		Activity c3 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, CLASS_SIZE, "A");
		assertEquals("Arranged", c3.getMeetingString());
		Activity c4 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, CLASS_SIZE, "TH", 1145, 1425);
	...
	public void testEqualsObject() {
		Activity c1 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, CLASS_SIZE, MEETING_DAYS, START_TIME, END_TIME);
		Activity c2 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, CLASS_SIZE, MEETING_DAYS, START_TIME, END_TIME);
		Activity c3 = new Course(NAME, "Different", SECTION, CREDITS, INSTRUCTOR_ID, CLASS_SIZE, MEETING_DAYS, START_TIME, END_TIME);
		Activity c4 = new Course(NAME, TITLE, "002", CREDITS, INSTRUCTOR_ID, CLASS_SIZE, MEETING_DAYS, START_TIME, END_TIME);
		Activity c5 = new Course(NAME, TITLE, SECTION, 5, INSTRUCTOR_ID, CLASS_SIZE, MEETING_DAYS, START_TIME, END_TIME);
		Activity c6 = new Course(NAME, TITLE, SECTION, CREDITS, "Different", CLASS_SIZE, MEETING_DAYS, START_TIME, END_TIME);
		Activity c7 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, CLASS_SIZE, "TH", START_TIME, END_TIME);
		Activity c8 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, CLASS_SIZE, MEETING_DAYS, 830, END_TIME);
		Activity c9 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, CLASS_SIZE, MEETING_DAYS, START_TIME, 1400);
	...
	public void testToString() {
		...
		Activity c2 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, CLASS_SIZE, "A");
		String s2 = "CSC216,Programming Concepts - Java,001,4,sesmith5,10,A";
		assertEquals(s2, c2.toString());
	}
	
	/**
	 * Tests the compareTo method of courses.
	 * compareTo() will return a negative number if the calling course is "comes before" the passed-in course.
	 * This means that the name of the current course would come first alphabetically, or the current section would be a lower number.
	 * Name has a higher weight than section in sorting.
	 */
	@Test
	public void testCompareTo() {
	    Course c1 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, CLASS_SIZE, MEETING_DAYS, START_TIME, END_TIME);
	    Course c2 = new Course("MA242", "Calculus III for Scientists and Engineers", "003", 4, "lakurtz", CLASS_SIZE, "MWF", 935, 1025);
	    Course c3 = new Course(NAME, TITLE, "003", CREDITS, INSTRUCTOR_ID, CLASS_SIZE, MEETING_DAYS, START_TIME, END_TIME);
	 ...
	 * isDuplicate() should return true if one course has the same name and section as another course.
	 */
	@Test
	public void testIsDuplicate() {
	    Activity c1 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, CLASS_SIZE, MEETING_DAYS, START_TIME, END_TIME);
	    Activity c2 = new Course("MA242", "Calculus III for Scientists and Engineers", "003", 4, "lakurtz", CLASS_SIZE, "MWF", 935, 1025);
        Activity c3 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, CLASS_SIZE, MEETING_DAYS, START_TIME, END_TIME);
	...
	/**
	 * Tests the two display array methods in Course.
	 * getShortDisplayArray() will return an array with the name, sectiton, title, and meeting string of the Course.
	 * getLongDisplayArray() will return an array with the name, section, title, credits, instructor id, and meeting string of the Course.
	 */
	@Test
	public void testDisplayArrays() {
	    Activity c1 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, CLASS_SIZE, MEETING_DAYS, START_TIME, END_TIME);
	    String[] a1 = c1.getShortDisplayArray();
	    String[] a2 = c1.getLongDisplayArray();
	    
	    assertArrayEquals(a1, new String[]{NAME, SECTION, TITLE, MEETING_DAYS + " " + "1:30PM-2:45PM", "10"});
	    assertArrayEquals(a2, new String[] {NAME, SECTION, TITLE, "" + CREDITS, INSTRUCTOR_ID, MEETING_DAYS + " " + "1:30PM-2:45PM", ""});
	}
}
