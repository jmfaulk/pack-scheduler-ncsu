...
public class StudentDirectory {
	 ...
	 * @throws IllegalArgumentException thrown if unable to read file
	 */
	 ...
	 * @throws IllegalArgumentException thrown if password is invalid
	 */
	...
	/**
	 * Class to check if a student with a particular id is within the directory
	 * @param id the id of the target student
	 * @return the Student object containing the target id, or a null student if this
	 * 			Student does not exist in the directory
	 */
